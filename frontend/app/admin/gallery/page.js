          ...
          <tbody>
            ...
            <tr className="bg-blue-50">
              ...
              <td className="p-2 border">
                <button
                  onClick={createAlbum}
                  className="bg-ahsra-blue text-white px-3 py-1 rounded text-xs"
                >
                  Add Album
                </button>
              </td>
              ...
              <tr key={a.id} className="hover:bg-gray-50">
                ...
                <td className="p-3 border space-x-3">
                  <button
                    ...
                    className="text-ahsra-blue text-xs"
                  >
                    Manage Photos
                  </button>
                  <button
          ...
          <div className="bg-white w-full max-w-3xl rounded shadow-lg p-6">
            ...
            <div className="border rounded p-4 mb-6 bg-gray-50">
              <div className="grid md:grid-cols-3 gap-3">
                ...
                <button
                  onClick={uploadImage}
                  className="bg-ahsra-blue text-white rounded px-3 py-2 text-sm"
                >
                  Upload
                </button>
              </div>
